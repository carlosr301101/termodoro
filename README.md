...
```bash
cargo run -- start
cargo run -- start --work 50 --short-break 10 --long-break 20 --long-every 4
cargo run -- start --cycles 2
cargo run -- status
cargo run -- stop
cargo run -- config
cargo run -- config --work 30 --short-break 5 --long-break 15 --long-every 4
